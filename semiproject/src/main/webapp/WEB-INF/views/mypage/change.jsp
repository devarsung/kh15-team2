...
<%--                 </c:when> --%>
<%--                 <c:otherwise> --%>
<%--                     <img id="myPhoto" src="/attachment/download?attachmentNo=${attachmentNo}" data-before-src="/attachment/download?attachmentNo=${attachmentNo}"> --%>
<%--                 </c:otherwise> --%>
            ...
            <div class="cell mt-20">
                <table class="table table-border table-hover">
                    <tr>
                        <th>ID</th>
                    <td class="p-10">
                        <input name="memberId" type="text" class="field w-75" value="${memberDto.memberId}" readonly>
                    </td>
                    </tr>
                    <tr>
                        <th>닉네임</th>
                    <td class="p-10">
                        <input name="memberNickname" type="text" class="editInput field  w-75" value="${memberDto.memberNickname}" readonly>
                    ...
                    <th>성별</th>
                    <td class="p-10">
                        <input name="memberGender" type="text" class="field  w-75" value="${memberDto.memberGender}" readonly>
                    </td>
                    </tr>
                    <tr>
                        <th>생년월일</th>
                    <td class="p-10">
                        <input name="memberBirth"type="text" class="editInput field  w-75" value="${memberDto.memberBirth}" readonly>
                        <button type="button" class="editBtn"><i class="fa-solid fa-pen-to-square"></i></button>
                    ...
                    <tr>
                        <th>이메일</th>
                    <td class="p-10">
                        <input name="memberEmail"type="email" class="editInput field  w-75" value="${memberDto.memberEmail}" readonly>
                        <button type="button" class="editBtn"><i class="fa-solid fa-pen-to-square"></i></button>
                    ...
                    <tr>
                        <th>연락처</th>
                    <td class="p-10">
                        <input name="memberContact"type="text" class="editInput field  w-75" value="${memberDto.memberContact}" readonly>
                        <button type="button" class="editBtn "><i class="fa-solid fa-pen-to-square"></i></button>
                    ...
                    <tr>
                        <th>주소</th>
                    <td class="p-10">
                        <input name="memberPost"type="text" class="editInput field  w-75" placeholder="우편번호"  value="${memberDto.memberPost}" readonly>
                        <button type="button" class="editBtn"><i class="fa-solid fa-pen-to-square"></i></button>
                        <br>
                        <input name="memberAddress1" class="editInput field w-75" placeholder="기본주소" value="${memberDto.memberAddress1}"readonly >
                        <br>
                        <input name="memberAddress2" class="editInput field w-75" placeholder="상세주소" value="${memberDto.memberAddress2}" readonly>
                    ...
                    <tr>
                        ...
                        <td class="p-10">
                        <input name="memberPw" type="password" class="field w-50" placeholder="비밀번호를 확인">
